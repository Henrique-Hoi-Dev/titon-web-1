...
export const InfoFinancial = ({ showModal, setShowModal, financialId }) => {
  const status = [
  ...
  return (
    ...
    >
      ...
      <Grid container justifyContent="center" padding={"30px 15px"} spacing={2}>
        <Grid
          item
          xs={6}
          md={3}
            ...
            >
              ...
              >
                <CardMedia
                  component="img"
                  height="150px"
                  sx={{ borderRadius: "8px", width: "248px", height: "185px" }}
              ...
              >
                ...
                >
                  <Text
                    fontSize={"19px"}
                    color={
                      getStatus(financial?.dataResult?.freigth[0]?.status_check)
                        .color
                    }
                  >
                    {
