...
import ModalUpdateSalespoint from "./modalUpdateSalespoint";
...
const Table = (
  ...
  const [showModalUpdateSalespoint, setShowModalUpdateSalespoint] = useState(false);
  ...
  return (
    <>
            ...
            <STableBody>
              {data?.items?.map((item, index) => (
                <InfoRow
                  ...
                  setShowModalUpdateSalespoint={setShowModalUpdateSalespoint}
                />
              ))}
            </STableBody>
          )}
      ...
      {showModalUpdateSalespoint && (
        <ModalUpdateSalespoint
          showModal={showModalUpdateSalespoint}
          setShowModal={setShowModalUpdateSalespoint}
