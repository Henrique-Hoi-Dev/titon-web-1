...
const ModalWinnersRoundId = (
  ...
  const { data } = useGetBingo("bingo-reports/card/winners", query, id ? false : true);
  ...
  return (
    ...
    >
      <ContentHeader>
        <Title>{t("menu.draw")}:  <Text>{id}</Text></Title>
        </ContentHeader>
...
export default ModalWinnersRoundId;
