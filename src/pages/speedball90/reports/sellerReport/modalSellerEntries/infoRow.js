    ...
    return (  
      <>
        <SRow sx={{ '& > *': { borderBottom: 'unset' } }} alternatingcolors={index}>
          ...
          <SCell>{data.id}</SCell>
          <SCell displaywidth={isMobileMax ? 1 : 0}>{data.device_id}</SCell>
          <SCell displaywidth={isMobileMax ? 1 : 0}>{data.collector_id}</SCell>
          <SCell displaywidth={isMobileMax ? 1 : 0}>{data.device_number}</SCell>
          <SCell displaywidth={isTabletMax ? 1 : 0}>{data.salespoint_name}</SCell>
          <SCell displaywidth={isTabletMax ? 1 : 0}>{data.room_name}</SCell>
          <SCell displaywidth={isTabletMax ? 1 : 0}>{data.seller_name}</SCell>
