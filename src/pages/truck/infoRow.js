  ...
  return (
    <>
      <SRow key={data.id} alternatingcolors={index} >
        ...
        <SCell displaywidth={isSmallDesktop ? 1 : 0}>{data.truck_board}</SCell>
        <SCell displaywidth={isSmallDesktop ? 1 : 0}>{data.truck_color}</SCell>
        <SCell displaywidth={isSmallDesktop ? 1 : 0}>{data.truck_km}</SCell>
        <SCell displaywidth={isSmallDesktop ? 1 : 0}>{data.truck_chassis}</SCell>
      ...
      >
        ...
        <MenuItem onClick={() => handleDelete(data?.id, `${(data?.truck_name_brand + " ") + (data?.truck_models)}`)}>Excluir</MenuItem>
      </Menu>
