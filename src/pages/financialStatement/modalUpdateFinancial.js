      ...
      {!isFetching && !isValidating && (
        ...
        >
          <Grid item xs={12} md={12} lg={12}>
            ...
            <Text sx={{ ml: 1, fontSize: "16px!important" }}>{financial?.dataResult?.driver_name}</Text>              
          </Grid> 

          <Grid item xs={12} md={12} lg={12}>
            <Text sx={{ ml: 1, fontWeight: "900" }}>Caminhão:</Text>
            <Text sx={{ ml: 1, fontSize: "16px!important" }}>{financial?.dataResult?.truck_models}</Text>             
          </Grid> 

          <Grid item xs={12} md={12} lg={12}>
            <Text sx={{ ml: 1, fontWeight: "900" }}>Carreta:</Text>
            <Text sx={{ ml: 1, fontSize: "16px!important" }}>{financial?.dataResult?.cart_models}</Text>              
          </Grid>
