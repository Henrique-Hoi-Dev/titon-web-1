          ...
          >
            ...
            <Grid item md={3} lg={3}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {Math.round(
                    checks?.dataResult?.first_check?.travel_km / 1000
                  )}{" "}
                  Km
                </Text>
              </Grid>
            ...
            <Grid item md={3} lg={3}>
              <Text
                sx={{ ml: 1, fontWeight: "900", whiteSpace: "break-spaces" }}
              >
                Prévia Tonelada
              </Text>
              <Grid item container xs={12} md={12} lg={12}>
            ...
            <Grid item md={3} lg={3}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {moneyMask(
                    checks?.dataResult?.first_check?.value_tonne || [0]
                  )}
                </Text>
              </Grid>
            </Grid>
            ...
            <Grid item md={3} lg={3}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {moneyMask(
                    checks?.dataResult?.first_check?.preview_value_diesel || [0]
                  )}
                </Text>
              </Grid>
            </Grid>
            ...
            <Grid item md={6} lg={6}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {moneyMask(
                    checks?.dataResult?.first_check?.item_total
                      .preview_valueGross
                  )}
                </Text>
              </Grid>
            ...
            <Grid item md={6} lg={6}>
              <hr style={{ width: "280px", margin: "12px" }} />
              <Text sx={{ ml: 1, fontWeight: "900" }}>
                Prévia Gasto Combustível
              </Text>
              <Grid item container xs={12} md={12} lg={12}>
                <Text
                  sx={{ ml: 2, fontWeight: "600", color: "#333" }}
          ...
          >
            ...
            <Grid item md={6} lg={6}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {moneyMask(
                    checks?.dataResult?.second_check?.toll_value || [0]
                  )}
                </Text>
              </Grid>
            </Grid>
            ...
            <Grid item md={6} lg={6}>
              ...
              <Grid item container xs={12} md={12} lg={12}>
                ...
                >
                  {moneyMask(
                    checks?.dataResult?.second_check?.item_total
