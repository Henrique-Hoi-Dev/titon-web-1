...
export const formatMoney = (value) => {
  ...
  const result = new Intl.NumberFormat('pt-BR', options).format(parseFloat(value) / 100) || 0;
...
export const formatMil = (value, status) => {
  ...
  const result = new Intl.NumberFormat('pt-BR', options).format(parseFloat(value) / 1000) || 0;
