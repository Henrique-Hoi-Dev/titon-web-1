...
const Table = (
  ...
  const [showModalUpdateLine, setShowModalUpdateLine] = useState(false);
  ...
  return (
    <>
            ...
            <STableBody>
              {data?.items.map((item, index) => (
                <InfoRow
                  ...
                  setShowModalUpdateLine={setShowModalUpdateLine}
                />
              ))}
            </STableBody>
          )}
      ...
      {showModalUpdateLine && (
        <ModalUpdateLine
          showModal={showModalUpdateLine}
          setShowModal={setShowModalUpdateLine}
          lineId={lineId}
