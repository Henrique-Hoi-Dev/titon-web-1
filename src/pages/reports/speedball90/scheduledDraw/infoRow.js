  ...
  return (
    <>
      <SRow key={data.round_id} alternatingcolors={index}>
        ...
        <SCell displaywidth={isMobile ? 1 : 0}>{moneyMask(data.card_value)}</SCell>
        <SCell displaywidth={isDesktop ? 1 : 0}>{moneyMask(data.line)}</SCell>
        <SCell displaywidth={isDesktop ? 1 : 0}>{moneyMask(data.double_line)}</SCell>
        <SCell displaywidth={isDesktop ? 1 : 0}>{moneyMask(data.bingo)}</SCell>
        <SCell  displaywidth={isMobile ? 1 : 0}>{moneyMask(data.prize_total)}</SCell>
        <SCell minwidth={"70px"}>
          <IconDelete
            sx={{ cursor: "pointer" }}
