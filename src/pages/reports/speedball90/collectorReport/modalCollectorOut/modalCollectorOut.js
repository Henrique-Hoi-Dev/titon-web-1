...
const ModalCollectorOut = (
  ...
  const { data } = useGetBingo("bingo-reports/collector/report/out", query, id ? false : true);
...
export default ModalCollectorOut;
